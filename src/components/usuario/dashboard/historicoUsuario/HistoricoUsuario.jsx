...
function HistoricoUsuario() {
    ...
    const getOperacoes = async () => {
        ...
        try {
        const response = await axios.get('https://trocai-api-gd42.onrender.com/plataforma/consultar_operacao?id_usuario=1');
                        ...
                        trocas.map((troca) =>    
                            <div className='boxItem' key={troca['Operação ID']}>
                                <div className='divImg'>
                                    <img className='imgItem' src={`https://trocai-api-gd42.onrender.com/produto/${troca['Imagem1']}`} alt="Imagem" />
                                </div>
                                <div>
                    ...
                    {operacoes.length === 0 ? (<p>Carregando...</p>) : (
                        doacoes.map((doacao) =>    
                            <div className='boxItem' key={doacao['Operação ID']}>
                                <div className='divImg'>
                                    <img className='imgItem' src={`https://trocai-api-gd42.onrender.com/produto/${doacao['Imagem1']}`} alt="Imagem" />
                                </div>
                                <div>
