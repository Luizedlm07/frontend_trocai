...
function FirstPage() {
    ...
    useEffect(() => {
        axios.get('https://trocai-api-gd42.onrender.com/plataforma/consultar_feed')
        ...
        <div className="firstConteiner">
            ...
            <div className='itensConteiner'>
                {itens.length === 0 ? (<p>Carregando...</p>) : (
                    ...
                    <div className="item">
                        <article>
                            <img className="itemImg" src={`https://trocai-api-gd42.onrender.com/produto/${item.imagem}`} alt="imagem"/>
                        </article>
